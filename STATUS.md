...
| Kyberia Lab MCP | Implementation worktree `feat/lab-mcp` | Official-SDK stdio coordinator, authenticated signed runner protocol, fixed allowlists, retained evidence and local contract tests implemented; independent security review and physical Windows/Kismet/CUDA/spectrum gates remain |
