...
| Phase 5 spectrum evidence contract | Isolated `feat/phase5-spectrum-current` | Signature rules v2 fail closed for dBm/Hz and require 80% per-bin coverage across event sweeps; 14 synthetic contract tests pass. No SoapySDR/vendor adapter, bandwidth normalization, hardware, remote-sensor or labeled-trace execution. Independent review and all Phase 5 runtime gates remain open; see [validation](docs/validation/phase5-spectrum-contract.md) |
