...
| --- | --- | --- |
| Phase 8 plugin contract foundation | Candidate `feat/phase8-plugin-sdk-current`; `phase8-plugin-sdk` | Focused declaration/negotiation tests pass. Independent code review, WIT compiler validation, third-party sample collector/metric/export, runtime invocation, resource enforcement, sandboxing, and project integration remain open; no Phase 8 exit or SEC-002 completion is claimed |
