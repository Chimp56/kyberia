...
code or tests are removed by the correction. Integration approval awaits the
frozen correction commit and its format/lint checks.
...
suite; it remains a reliability diagnostic to investigate if it recurs.
